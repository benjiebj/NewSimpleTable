...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //Para lumabas sa Simulator
    newsimpletableViewController *viewController = [[newsimpletableViewController alloc] initWithNibName:@"newsimpletableViewController" bundle:nil];
